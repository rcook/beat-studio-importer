...
class Backend:
    ...
    # -> Any:
    def open_input(self, name=..., virtual=..., callback=..., **kwargs):
        """Open an input port.
    ...
    # -> Any:
    def open_output(self, name=..., virtual=..., autoreset=..., **kwargs):
        """Open an output port.
    ...
    # -> Any | IOPort:
    def open_ioport(self, name=..., virtual=..., callback=..., autoreset=..., **kwargs):
